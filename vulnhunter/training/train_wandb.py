"""
VulnHunter GRPO Training with Weights & Biases
This version includes W&B logging for visualization.
"""
import os
import json
import re
...
MAX_SEQ_LENGTH = 2048
OUTPUT_DIR = "./vulnhunter-agent-wandb"
HF_MODEL_NAME = "gateremark/vulnhunter-agent-wandb"

print("=" * 60)
print("VulnHunter GRPO Training (W&B Version)")
print("=" * 60)
...
print("\n[2/4] Configuring GRPO trainer with W&B...")
training_args = GRPOConfig(
    ...
    bf16=True,
    run_name="vulnhunter-grpo",  # W&B run name
)
...
print("\n[3/4] Starting GRPO training with W&B logging...")
trainer.train()
...
print("\n" + "=" * 60)
print("Training complete with W&B logging!")
print(f"Model saved locally: {OUTPUT_DIR}")
print(f"Model on HF: huggingface.co/{HF_MODEL_NAME}")
print("Check W&B dashboard for training graphs!")
print("=" * 60)
